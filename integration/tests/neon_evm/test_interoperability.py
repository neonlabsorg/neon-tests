...
class TestInteroperability:
    ...
    def test_revision_2_txs_from_1_sender(self, sender_with_tokens, solana_caller, evm_loader, holder_acc, new_holder_acc, neon_api_client, operator_keypair, treasury_pool, sol_client, solana_client):
