...
class SolanaClient(solana.rpc.api.Client):
    ...
    def send_tx_and_check_status_ok(self, tx, *signers, wait_status=Processed) -> None:
        opts = TxOpts(skip_preflight=True, skip_confirmation=False, preflight_commitment=wait_status)
    ...
    def send_tx(self, trx: Transaction, *signers: Keypair, wait_status=Processed) -> GetTransactionResp:
        ...
        self.confirm_transaction(result.value, commitment=Processed)
