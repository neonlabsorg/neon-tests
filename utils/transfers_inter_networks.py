...
def neon_transfer_tx(
    ...
    emulated_contract_pubkey = PublicKey(sol_client.ether2program(emulate_signer.address, evm_loader_id)[0])
    ...
    compute_budget_instruction = Instruction.compute_budget_utils(solana_account)
