...
| TestRpcGetTransaction::test_get_scheduled_transaction_by_parameters:eth_getTransactionByHash                              | Positive cases                                                          |         |
| TestRpcGetTransaction::test_get_scheduled_transaction_by_parameters:eth_getTransactionByBlockNumberAndIndex               | Positive cases                                                          |         |
| TestRpcGetTransaction::test_get_scheduled_transaction_by_parameters:eth_getTransactionByBlockHashAndIndex                 | Positive cases                                                          |         |
| TestRpcGetTransaction::test_get_scheduled_transaction_by_sender_nonce                                                     | Positive cases                                                          |         |
| TestRpcGetTransaction::test_neon_get_reverted_scheduled_transaction_by_parameters:eth_getTransactionByHash                | Positive cases                                                          |         |
| TestRpcGetTransaction::test_neon_get_reverted_scheduled_transaction_by_parameters:eth_getTransactionByBlockNumberAndIndex | Positive cases                                                          |         |
| TestRpcGetTransaction::test_neon_get_reverted_scheduled_transaction_by_parameters:eth_getTransactionByBlockHashAndIndex   | Positive cases                                                          |         |
| TestRpcGetTransaction::test_neon_get_reverted_scheduled_transaction_by_parameters:eth_getTransactionByBlockHashAndIndex   | Positive cases                                                          |         |
| TestRpcGetTransaction::test_get_scheduled_transaction_receipt:neon_getTransactionReceipt                                  | Positive cases                                                          |         |
| TestRpcGetTransaction::test_get_scheduled_transaction_receipt:eth_getTransactionReceipt                                   | Positive cases                                                          |         |
| TestRpcGetTransaction::test_get_multiple_scheduled_transaction_receipt:neon_getTransactionReceipt                         | Positive cases                                                          |         |
| TestRpcGetTransaction::test_get_multiple_scheduled_transaction_receipt:eth_getTransactionReceipt                          | Positive cases                                                          |         |
